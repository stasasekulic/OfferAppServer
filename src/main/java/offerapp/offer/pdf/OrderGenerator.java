...
public class OrderGenerator {
    ...
    public OrderGenerator(OfferService offerService) {
    ...
    public byte[] generateManufacturingOrderPdf(Long offerId) {
        OfferResponse offer = offerService.getOfferById(offerId);
    ...
    public byte[] generateGoodsIssueOrderPdf(Long offerId) {
        OfferResponse offer = offerService.getOfferById(offerId);
    ...
    public byte[] generateBillingOrderPdf(Long offerId) {
        OfferResponse offer = offerService.getOfferById(offerId);
